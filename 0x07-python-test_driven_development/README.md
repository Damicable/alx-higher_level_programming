This project 0x07. Python - Test-driven development is test driven by the contex. It emphasized on the need to pay attention to details before coding.
Ability to create your test cases as a basis to check your own codes.
LEARNING OBJECTIVES:
